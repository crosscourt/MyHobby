...
{
    public class RequireLoginAttribute : System.Web.Http.AuthorizeAttribute
    {
        ...
        private bool TryGetPrincipal(string authHeader, out IPrincipal principal)
        {
            ...
            {
                CustomIdentity identity = new CustomIdentity(token.UserId, token.UserName, token.Timezone, token.Language, token.Role, false);
